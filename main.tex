...
\documentclass[sigplan,10pt,screen,nonacm]{acmart}
...
\title[MatrixFold: Accelerating Mixed-Precision Alphafold Inference on CPU]{MatrixFold: Accelerating Mixed-Precision Alphafold Inference via Outer Product Unit on Manycore CPUs}
%
