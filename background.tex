...
The 72F processor is an ARM CPU equipped with the SME. SME extends the AArch64 architecture with a two-dimensional matrix register file (ZA registers) and dedicated outer-product execution units, enabling high-throughput matrix operations with hardware-managed accumulation.
